package com.tang.gateway.security;

import com.tang.common.base.constant.SecurityConstants;
import com.tang.common.base.result.ResultCode;
import com.tang.gateway.util.ResponseUtils;
...
/**
 * @description: 设置对哪些请求进行拦截，和如何解析token内容的
 * @author: tzq
 * @time: 2023/6/19 16:56
 */
@AllArgsConstructor
@Configuration
